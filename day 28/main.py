...
timer_text = canvas.create_text(98, 130, text="00:00", fill="white", font=(FONT_NAME, 35, "bold"))
canvas.grid(row=1, column=1)


label_1 = Label(text="TIMER", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 50))
label_1.grid(row=0, column=1)

label_2 = Label(text="✔", fg=GREEN, bg=YELLOW)
